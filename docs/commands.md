...
You can change the default behavior by [syncOption](https://github.com/khoazero123/vscode-sftp/wiki/Configuration#syncoption).
...
*Only [skipCreate](https://github.com/khoazero123/vscode-sftp/wiki/Configuration#syncoptionskipcreate) and [ignoreExisting](https://github.com/khoazero123/vscode-sftp/wiki/Configuration#syncoptionignoreexisting) are valid for this command.*
